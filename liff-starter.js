    ...
    document.getElementById('sendmessagebutton483').addEventListener('click', function () {
        liff.sendMessages([{
          ...
          template: {
             type: 'image_carousel',
             columns: [{
                 imageUrl: 'http://dl.stickershop.line.naver.jp/products/0/0/4/537/android/stickers/2468.png',
                 action: {
                     type: 'uri',
    ...
    document.getElementById('sendmessagebutton484').addEventListener('click', function () {
        liff.sendMessages([{
          ...
          template: {
             type: 'image_carousel',
             columns: [{
                 imageUrl: 'http://dl.stickershop.line.naver.jp/products/0/0/4/537/android/stickers/2469.png',
                 action: {
                     type: 'uri',
                     uri: 'line://shop/sticker/detail/537'}}
                          ]
    ...
    document.getElementById('sendmessagebutton485').addEventListener('click', function () {
        liff.sendMessages([{
          ...
          template: {
             type: 'image_carousel',
             columns: [{
                 imageUrl: 'http://dl.stickershop.line.naver.jp/products/0/0/4/537/android/stickers/2470.png',
                 action: {
                     type: 'uri',
                     uri: 'line://shop/sticker/detail/537'}}
                          ]
    ...
    document.getElementById('sendmessagebutton486').addEventListener('click', function () {
        liff.sendMessages([{
          ...
          template: {
             type: 'image_carousel',
             columns: [{
                 imageUrl: 'http://dl.stickershop.line.naver.jp/products/0/0/4/537/android/stickers/2471.png',
                 action: {
                     type: 'uri',
                     uri: 'line://shop/sticker/detail/537'}}
                          ]
    ...
    document.getElementById('sendmessagebutton487').addEventListener('click', function () {
        liff.sendMessages([{
          ...
          template: {
             type: 'image_carousel',
             columns: [{
                 imageUrl: 'http://dl.stickershop.line.naver.jp/products/0/0/4/537/android/stickers/2472.png',
                 action: {
                     type: 'uri',
                     uri: 'line://shop/sticker/detail/537'}}
                          ]
    ...
    document.getElementById('sendmessagebutton488').addEventListener('click', function () {
        liff.sendMessages([{
          ...
          template: {
             type: 'image_carousel',
             columns: [{
                 imageUrl: 'http://dl.stickershop.line.naver.jp/products/0/0/4/537/android/stickers/2473.png',
                 action: {
                     type: 'uri',
                     uri: 'line://shop/sticker/detail/537'}}
                          ]
    ...
    document.getElementById('sendmessagebutton489').addEventListener('click', function () {
        liff.sendMessages([{
          ...
          template: {
             type: 'image_carousel',
             columns: [{
                 imageUrl: 'http://dl.stickershop.line.naver.jp/products/0/0/4/537/android/stickers/2474.png',
                 action: {
                     type: 'uri',
                     uri: 'line://shop/sticker/detail/537'}}
                          ]
    ...
    document.getElementById('sendmessagebutton490').addEventListener('click', function () {
        liff.sendMessages([{
          ...
          template: {
             type: 'image_carousel',
             columns: [{
                 imageUrl: 'http://dl.stickershop.line.naver.jp/products/0/0/4/537/android/stickers/2475.png',
                 action: {
                     type: 'uri',
                     uri: 'line://shop/sticker/detail/537'}}
                          ]
    ...
    document.getElementById('sendmessagebutton491').addEventListener('click', function () {
        liff.sendMessages([{
          ...
          template: {
             type: 'image_carousel',
             columns: [{
                 imageUrl: 'http://dl.stickershop.line.naver.jp/products/0/0/1/660/android/stickers/7023.png',
                 action: {
                     type: 'uri',
    ...
    document.getElementById('sendmessagebutton492').addEventListener('click', function () {
        liff.sendMessages([{
          ...
          template: {
             type: 'image_carousel',
             columns: [{
                 imageUrl: 'http://dl.stickershop.line.naver.jp/products/0/0/1/660/android/stickers/7024.png',
                 action: {
                     type: 'uri',
                     uri: 'line://shop/sticker/detail/660'}}
                          ]
    ...
    document.getElementById('sendmessagebutton493').addEventListener('click', function () {
        liff.sendMessages([{
          ...
          template: {
             type: 'image_carousel',
             columns: [{
                 imageUrl: 'http://dl.stickershop.line.naver.jp/products/0/0/1/660/android/stickers/7025.png',
                 action: {
                     type: 'uri',
                     uri: 'line://shop/sticker/detail/660'}}
                          ]
    ...
    document.getElementById('sendmessagebutton494').addEventListener('click', function () {
        liff.sendMessages([{
          ...
          template: {
             type: 'image_carousel',
             columns: [{
                 imageUrl: 'http://dl.stickershop.line.naver.jp/products/0/0/1/660/android/stickers/7026.png',
                 action: {
                     type: 'uri',
                     uri: 'line://shop/sticker/detail/660'}}
                          ]
    ...
    document.getElementById('sendmessagebutton495').addEventListener('click', function () {
        liff.sendMessages([{
          ...
          template: {
             type: 'image_carousel',
             columns: [{
                 imageUrl: 'http://dl.stickershop.line.naver.jp/products/0/0/1/660/android/stickers/7027.png',
                 action: {
                     type: 'uri',
                     uri: 'line://shop/sticker/detail/660'}}
                          ]
    ...
    document.getElementById('sendmessagebutton496').addEventListener('click', function () {
        liff.sendMessages([{
          ...
          template: {
             type: 'image_carousel',
             columns: [{
                 imageUrl: 'http://dl.stickershop.line.naver.jp/products/0/0/1/660/android/stickers/7028.png',
                 action: {
                     type: 'uri',
                     uri: 'line://shop/sticker/detail/660'}}
                          ]
    ...
    document.getElementById('sendmessagebutton497').addEventListener('click', function () {
        liff.sendMessages([{
          ...
          template: {
             type: 'image_carousel',
             columns: [{
                 imageUrl: 'http://dl.stickershop.line.naver.jp/products/0/0/1/660/android/stickers/7029.png',
                 action: {
                     type: 'uri',
                     uri: 'line://shop/sticker/detail/660'}}
                          ]
    ...
    document.getElementById('sendmessagebutton498').addEventListener('click', function () {
        liff.sendMessages([{
          ...
          template: {
             type: 'image_carousel',
             columns: [{
                 imageUrl: 'http://dl.stickershop.line.naver.jp/products/0/0/1/660/android/stickers/7030.png',
                 action: {
                     type: 'uri',
                     uri: 'line://shop/sticker/detail/660'}}
                          ]
